...
const FileCard = ({
  ...
  const formatDate = (dateString) => {
    const date = new Date(dateString); // or some other date parsing utility.
  ...
  return (
    <div
      ...
      className="relative group overflow-hidden rounded-xl bg-whites shadow-md hover:shadow-lg translate-x-0 duration-300 border border-gray-300"
    >
      {/* File preview area */}
