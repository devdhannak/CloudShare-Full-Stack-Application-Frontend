        ...
        <div className="mt-16 space-y-12 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-8">
          {pricingPlans.map((plan, index) => {
            return (
              ...
              >
                <div
                  className={`px-6 py-8 bg-white flex-shrink-0 ${plan.highlighted ? "bg-gradient-to-br from-purple-50 to-white" : ""}`}
                >
                ...
                <div className="flex-1 flex flex-col justify-between px-6 pt-6 mb-8 bg-gray-50 space-y-6">
