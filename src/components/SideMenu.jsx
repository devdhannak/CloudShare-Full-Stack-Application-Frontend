...
const SideMenu = ({ activeMenu }) => {
  ...
  return (
    <div className="w-64 h-[calc(100vh-70px)] bg-white border-r border-x-gray-200/50 p-5 sticky top-[61px]z-20">
      <div className="flex flex-col items-center justify-center gap-3 mt-3 mb-7">
        {user?.imageUrl ? (
          <img
            src={user.imageUrl || ""}
            alt="profile"
            className="w-[60px] h-[60px] bg-slate-400 rounded-full border border-gray-100 shadow-sm"
          />
        ) : (
